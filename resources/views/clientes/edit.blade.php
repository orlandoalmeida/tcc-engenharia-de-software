            ...
            <div class="row">
                <div class="topo-cadastros col-12">
                    <div class="page-title-box d-flex align-items-center justify-content-between">
                        <h4 class="mb-0 font-size-18">Editar Cliente</h4>
                    </div>
                    <div class="">
                            ...
                            <div class="row">
                                <div class="col form-group">
                                    ...
                                    <input type="file" id="input-file-now-custom-1" name="foto_perfil"
                                        ...
                                        data-default-file="{{ asset("$cliente->foto_perfil") }}" />
                                </div>
                            </div>
...
@section('app-js')
    ...
    <script>
        $('#menu-clientes-index a').addClass('active mm-active');
        $('#menu-clientes ul').addClass("mm-show active mm-active").attr("aria-expanded", "true");
