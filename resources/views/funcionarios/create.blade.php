            ...
            <div class="row">
                <div class="topo-cadastros col-12">
                    <div class="page-title-box d-flex align-items-center justify-content-between">
                        <h4 class="mb-0 font-size-18">Novo Funcionário</h4>
                    </div>
                    <div class="">
                        ...
                        <form action="{{ route('funcionario.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col">
                                    ...
                                    <input type="text" id="rg" name="rg" value="{{ old('rg') }}" class="form-control rg"
                                ...
                                <div class="col">
                                    ...
                                    <input type="text" id="data_nascimento" name="data_nascimento"
                                        value="{{ old('data_nascimento') }}" class="form-control data"
